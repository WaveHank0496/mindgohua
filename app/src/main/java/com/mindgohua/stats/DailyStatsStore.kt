 ...
 *
 * 預設是關閉的（[com.mindgohua.settings.AppSettings.statsEnabled]），
...
private val Context.statsStore: DataStore<Preferences> by preferencesDataStore(name = "mindgohua_daily_stats")
