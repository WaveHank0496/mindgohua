...
import com.catgatekeeper.core.DismissChoice
import com.catgatekeeper.core.DayBoundary
import com.catgatekeeper.core.EngineEffect
import com.catgatekeeper.core.SessionEngine
import com.catgatekeeper.core.SessionEvent
import com.catgatekeeper.detect.Detector
import com.catgatekeeper.detect.DetectorDebug
import com.catgatekeeper.detect.DetectorDebugBus
import com.catgatekeeper.detect.ScrollAccessibilityDetector
import com.catgatekeeper.detect.UsageStatsDetector
import com.catgatekeeper.overlay.CounterHud
import com.catgatekeeper.overlay.OverlayController
...
import com.catgatekeeper.stats.DailyStatsStore
import com.catgatekeeper.stats.SurvivalLog
import com.catgatekeeper.ui.MainActivity
...
class GatekeeperService : Service() {
    ...
    private fun buildNotification(text: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("Cat Gatekeeper")
            .setContentText(text)
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "cat_gatekeeper_ongoing"
        private const val NOTIFICATION_ID = 1001

        /** 每日計數多久寫一次磁碟。太密會一直做 I/O，太疏會在服務被殺時丟資料。 */
        private const val FLUSH_INTERVAL_MS = 15_000L

        const val ACTION_STOP = "com.catgatekeeper.action.STOP"
